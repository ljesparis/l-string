...
module.exports = function() {
  ...
  String.prototype.add2TagClassName = function(_tag, _classvalue) {
    return add2TagClassName(this, _tag, _classvalue);
  };

  String.prototype.add2TagIdName = function(_tag, _idvalue) {
    return add2TagIdName(this, _tag, _idvalue);
  };

  String.prototype.add2TagStyle = function(_tag, _styles) {
    return add2TagStyle(this, _tag, _styles);
  };

  String.prototype.add2TagAttr = function(_string, _tag, attrname, attrs) {
    return add2TagAttr(this, _string, _tag, attrname, attrs);
  }
}