...
const isUpper          = string.isUpper;
const isLower          = string.isLower;
const isAlpha          = string.isAlpha;
const isDigit          = string.isDigit;
const isAlphanumeric   = string.isAlphanumeric;
const isEmpty          = string.isEmpty;
const rSlice           = string.rSlice;
const dummyCount       = string.dummyCount;
const capitalize       = string.capitalize;
const getCharPosition  = string.getCharPosition;
const reverse          = string.reverse;
const title            = string.title;
const lSplit           = string.lSplit;
const rSplit           = string.rSplit;
const isSubString      = string.isSubString;
const startsWith       = string.startsWith;
const endsWith         = string.endsWith;
const swapCase         = string.swapCase;
const trim             = string.trim;
const trimPrefix       = string.trimPrefix;
const rConCat          = string.rConCat;
const lConCat          = string.lConCat;
const lReplace         = string.lReplace;
const rReplace         = string.rReplace;
const join             = string.join;
const center           = string.center;
const lJust            = string.lJust;
const rJust            = string.rJust;
const remove           = string.remove;
const insert           = string.insert;
const toCharArray      = string.toCharArray;
const smartCount       = string.smartCount;
const escape           = html.escape;
const slugify          = html.slugify;
const removeTag        = html.removeTag;
const addClassName2Tag = html.addClassName2Tag;
const addIdName2Tag    = html.addIdName2Tag;
const addStyle2Tag     = html.addStyle2Tag;
const addAttr2Tag      = html.addAttr2Tag;
