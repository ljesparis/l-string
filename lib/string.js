...
exports.multiply = function(_string, _times) {
	...
	**/
	...
	if (typeof _times == "undefined" || _times <= 0)
		return _string;
...
exports.rslice = function(_string, _start, _end) {
	...
	**/
	...
	if (typeof _string  == "undefined" || 
		this.isAlpha(_start) && typeof _start != "undefined" ||
		this.isAlpha(_end) && typeof _end != "undefined" )
		return "";
...
exports.dummyCount = function(_string, _subString, _startSilce, _endSlice) {
	...
	**/
	...
	if (typeof _string  == "undefined" || typeof _subString == "undefined" ||
		this.isAlpha(_startSilce) &&  typeof _startSilce != "undefined" || 
		typeof _endSlice != "undefined" && this.isAlpha(_endSlice))
		return 0;

	if (typeof _startSilce == "undefined") 
		_startSilce = 0;

	if (typeof _endSlice == "undefined")
		_endSlice = this.getSize(_subString) + _startSilce;
...
/*
exports.count = function(_string, _subString){
	Still working on it...
}
*/
...
exports.getCharPosition = function(_string, _char) {
	...
	**/
	...
	if (typeof _char == "undefined" || typeof _string == "undefined") 
		return position;
...
exports.lsplit = function (_string, _subS, maxsplit) {
	...
	**/
	...
	if (this.isAlpha(maxsplit) || typeof maxsplit == "undefined")
		maxsplit = 0;

	if (typeof _string == "undefined")
		throw new TypeError("the first argument can't be null");
...
exports.isSubString = function(_string, _subString) {
	...
	**/
	...
	if (typeof _subString == "undefined" || typeof _string == "undefined") 
		return false;
...
exports.startsWith = function(_string, _prefix) {
	...
	**/
	...
	if (typeof _prefix == "undefined" || typeof _string == "undefined") 
		return false;
...
exports.endsWith = function(_string, _prefix) {
	...
	**/
	...
	if (typeof _string == "undefined" || typeof _prefix == "undefined")
		return false;
...
exports.lreplace = function(_string, _old, _new, maxreplace) {
	...
	**/
	...
	if(this.isAlpha(maxreplace) || typeof maxreplace == "undefined")
...
exports.center = function(_string, _times) {
	...
	**/
	...
	if(typeof _times == "undefined" || this.isAlpha(_times))
		_times = 0;
